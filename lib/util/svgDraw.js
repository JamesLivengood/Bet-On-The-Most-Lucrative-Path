...
export const connectElements = (svg , path, startElem, endElem) => {
  // debugger
    var svgContainer= $("div.node-tree-div");
    ...
    // call export const for drawing the path
